...
public class ForestBuilder extends LoggingObject {
	...
	public void addReplicasToForests(List<Forest> forests, ForestPlan forestPlan, AppConfig appConfig) {
		...
		/**
		 * TODO Test this. We're saying that if there's a replica data directory configured for a database, use that
		 * and ignore the incoming forest data directories.
		 */
		...
		for (Forest f : forests) {
			...
			// TODO Account for "" as a data directory
